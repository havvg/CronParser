 ...
 * Cron parser test
 *
 * @covers Cronparser::<protected>
 */
class CronparserTest extends PHPUnit_Framework_TestCase
{
    /**
     * @covers Cronparser::__construct
     * @covers Cronparser::setSchedule
     */
    public function testConstructException()
    {
        $this->assertInstanceOf('Cronparser', new Cronparser());
    ...
    public function scheduleProvider()
    {
        return array(
            ...
            array('2,17,32,47 * * * *', '2010-08-10 22:17:05', '2010-08-10 22:02:01', '2010-08-10 22:32:00', true),
            // Minutes 17,32 hours 2,14 every day
            array('17,32 2,14 * * *',   '2010-08-10 22:02:33', '2010-08-10 14:32:00', '2010-08-11 02:17:00', false),
            array('17,32 2,14 * * *',   '2010-08-11 14:17:21', '2010-08-10 14:32:00', '2010-08-11 14:32:00', true),
        );
    }
